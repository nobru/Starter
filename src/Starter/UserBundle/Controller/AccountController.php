...
use Starter\UserBundle\Form\AccountType;
...
class AccountController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StarterUserBundle:Account')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StarterUserBundle:Account')->find($id);
